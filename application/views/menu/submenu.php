                ...
                <tbody>
                    ...
                    <?php foreach ($subMenu as $sm) : ?>
                        <tr>
                            ...
                            <td><?= $sm['is_active']; ?></td>
                            <td>
                                <a href="" data-toggle="modal" data-target="#editSubMenuModal<?= $sm['id']; ?>" class="badge badge-success">Edit</a>
                                <a href="<?php base_url(); ?>hapusSubMenu/<?php echo $sm['id']; ?>" class="badge badge-danger" onclick="return confirm('Yakin.?');">Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="newSubMenuModalLabel">Add New SubmMenu</h5>
...
foreach ($subMenu as $sm) : $no++ ?>
    <div class="modal fade" id="editSubMenuModal<?= $sm['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="editSubMenuModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editSubMenuModalLabel">Edit SubmMenu</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="<?= base_url('menu/editSubmenu'); ?>" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <select name="menu_id" id="menu_id" class="form-control">
                                <option value="<?= $m['menu']; ?>">Select Menu</option>
                                <?php foreach ($menu as $m) : ?>
                                    <option value="<?= $m['id']; ?>"><?= $m['menu']; ?></option>
                                <?php endforeach; ?>
                            </select>
